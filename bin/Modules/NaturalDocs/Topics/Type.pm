...
use NaturalDocs::DefineMembers 
        ...
        'MERGE_GROUPINGS',      'MergeGroupings()',     'SetMergeGroupings()',  #ND+, merge
        'SORT_GROUPINGS',       'SortGroupings()',      'SetSortGroupings()',   #ND+, sort
        'MULTIPLE',             'Multiple()',           'SetMultiple()',        #ND+, package
        'SPLITABLE',            'Splittable()',         'SetSplittable()',      #ND+, package
        'DONTSUMMARIES',        'DontSummaries()',      'SetDontSummaries()',   #ND+, sumaries
        'CAN_GROUP_WITH';
...
our @EXPORT = ('SCOPE_NORMAL', 'SCOPE_START', 'SCOPE_END', 'SCOPE_ALWAYS_GLOBAL',
                'MULTIPLE_MERGE', 'MULTIPLE_SPLIT', 'MULTIPLE_SUMMARIES');      #ND+, package
...
#
#   Constants: MultipleType
#
#   The possible values for <Multiple()>.
#
#   MULTIPLE_START - Multiple images are merged.
#   MULTIPLE_SPLIT - Multiple images are merged and the split within splitable topics.
#
use constant MULTIPLE_MERGE => 1;
use constant MULTIPLE_SPLIT => 2;
use constant MULTIPLE_SUMMARIES => 3;
