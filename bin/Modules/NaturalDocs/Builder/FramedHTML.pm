...
sub BuildFile #(file)
    ...
    print OUTPUTFILEHANDLE
        ...
        # doesn't matter) and it makes the page slightly too wide for the frame.  
        #
        # On the flip side without it tables widths have problems (ND+)
        #
        # Mozilla and Opera handle it like champs either way because they Don't Suck(tm).
        #
        ...
        . '</head><body class="FramedContentPage" onLoad="NDOnLoad()">'
            ...
            . "\n\n\n"
                . $self->BuildContent($file)    #ND+, package/modeline
            . "\n\n\n"

            . $self->BuildToolTips()

                                                #ND+, syntax
            . $self->ClosingBrowserStyles($outputFile)
        . '</body></html>';
